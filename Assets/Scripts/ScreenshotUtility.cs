...
public class ScreenshotUtility : MonoBehaviour
{
	...
	void Awake () 
	{
		...
		if (!System.IO.Directory.Exists("D:/Projects/Unity/SuperSpartyBros/Assets/Screenshots")) {
            Debug.Log("create");
            System.IO.Directory.CreateDirectory("D:/Projects/Unity/SuperSpartyBros/Assets/Screenshots");
		}
	...
	{
		// Checks for input
		if (UnityEngine.Input.GetKeyDown(m_ScreenshotKey.ToLower()))
		{
            Debug.Log("s");
			...
			ScreenCapture.CaptureScreenshot("D:/Projects/Unity/SuperSpartyBros/Assets/Screenshots/Screenshot_" + 
			                              + width + "x" + height
			                              + "_"
			                              + m_ImageCount
			                              + ".png",
