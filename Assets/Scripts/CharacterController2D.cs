...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
        ...
        else if (_canDoubleJumb && CrossPlatformInputManager.GetButtonDown("Jump")) // if CanDoubleJump and jump button pressed, then allow player to double jump
        {
            DoJump();
            // disable double jump after double jumping scince you can do it only once 
            _canDoubleJumb = false;
        }
